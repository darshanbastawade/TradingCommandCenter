...
public sealed record PaperQualificationArtifact(int SchemaVersion, Guid PaperQualificationId,
    ...
    string PaperQualificationSha256);
...
public static class PaperQualificationEngine
{
    ...
    {
        if (value.SchemaVersion != 1 || value.PaperQualificationId == Guid.Empty ||
            ...
            value.SessionCount != value.SessionSha256.Count || value.SessionCount < 1 ||
            value.DistinctTradingDays < 1 || value.SubmittedOrders < 0 || value.FilledTrades < 0 ||
